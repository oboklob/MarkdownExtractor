...
class TestTextExtractor(unittest.TestCase):
    ...
    @patch('TextExtractor.md_from_html')
    ...
    @patch('TextExtractor.extract_text_to_fp')
    @patch('TextExtractor.extract')
    ...
    def test_extract_docx(self, mock_convert_to_markdown):
        ...
        result = extract('tests/resources/test.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document')
        self.assertEqual(result, 'Hello World')

    @patch('TextExtractor.extract_image_md')
